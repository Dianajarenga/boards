...
def create_user(**params):
    username = 'Test'
    return get_user_model().objects.create_user(username, **params)
...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_success(self):
        """Test create user with an existing payload is successful"""
        payload = {
            'email': 'testjarengadiana@gmail.com',
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='testjarengadiana@gmail.com', password='Testdiana123')
        payload = {
            'email': 'testjarengadiana@gmail.com',
            'password': 'wrong',
